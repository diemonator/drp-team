...
namespace App
{
    public partial class Form2 : Form
    {
        ...
        internal Form2(ISocialNetwork socialNetwork)
        {
            InitializeComponent();
            this.socialNetwork = socialNetwork;
            iterator = socialNetwork.CreateIterator();
        }
        ...
        {
            if (socialNetwork.Count == lb_items.Items.Count)
            {
                lb_items.Items.Clear();
            }
            if (!iterator.IsDone())
        ...
        {
            MessageBox.Show(socialNetwork[lb_items.SelectedIndex].Name + "'s email is " + socialNetwork[lb_items.SelectedIndex].Email, "Additional Info");
        }
